...
export const ProfilePage = () => {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* Topbar config */}
      <TopBarConfig title="Profile" rightConfig={[
        {
          iconName: "home",
          tooltip: "Home",
          clickCallback: () => { navigate({ to: '/goals' }) },
        },
        {
          iconName: "settings",
          tooltip: "Settings",
          clickCallback: () => { navigate({ to: '/settings' }) },
        }
        // TODOs #30: Avatar
      ]}/>
      ...
      {(goalsData || goalsIsLoading) && <div className="flex flex-col gap-3">
        {goalsData && goalsData.map((d) => {
        ...
        {goalsIsLoading && [...Array(3)].map((_, idx) => {
