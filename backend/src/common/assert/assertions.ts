 ...
 */
export function assertFound<T>(resource: T | null | undefined, message = 'Resource not found'): asserts resource is T {
  if (resource == null) {
 ...
 */
export function assertCanView<T extends { userId: number; publicity: GoalPublicity }>(
  resource: T,
  userId: number,
